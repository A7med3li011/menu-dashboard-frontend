...
const ProductsBySubcategory = () => {
  ...
  // 2. Fetch Products by Subcategory
    ...
    <div className="min-h-screen bg-primary p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-secondary rounded-lg shadow-lg p-6 mb-8">
          ...
          <div className="bg-popular/10 rounded-lg p-6">
            <div className="flex items-center mb-4">
              <Layers className="w-6 h-6 text-popular mr-3" />
            ...
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                {subcategory?.description && (
                  <p className="text-gray-400 text-sm mt-1">{subcategory.description}</p>
                )}
                ...
                {subcategory?.category?.title && (
                  <div className="mt-2 flex items-center">
                    <Tag className="w-4 h-4 text-popular mr-2" />
                    <span className="text-popular text-sm font-medium">
        ...
        <h2 className="text-2xl font-bold text-white mb-6">
          Products in this Subcategory ({products.length})
        </h2>
        {productsLoading && (
