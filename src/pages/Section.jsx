...
export default function Section() {
  ...
  const { mutate, isPending } = useMutation({
    ...
    mutationFn: (payload) => addSection(payload.title, token),
    onSuccess: () => {
      setTitle("");
  ...
  const { mutate: updateMutate, isPending: isUpdating } = useMutation({
    ...
    mutationFn: (payload) =>
      updateSection(selectedSection._id, payload.title, token),
    onSuccess: () => {
      setTitle("");
  ...
  const handleUpdateSection = () => {
    if (title.trim() && selectedSection) {
      updateMutate({ title: title.trim() });
    }
  };
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={!title.trim() || isPending || isUpdating}
